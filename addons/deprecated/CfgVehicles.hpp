class CfgVehicles
{
	class EGVAR(modules,baseMedic);
	class EGVAR(modules,spawnWreck);
	class EGVAR(modules,ambientAnimationMP);
	class EGVAR(modules,Animation);
	class EGVAR(modules,aiStationary);
	class EGVAR(modules,randomizeGearBackpacks);
	class EGVAR(modules,randomizeGearGoggles);
	class EGVAR(modules,randomizeGearHeadgear);
	class EGVAR(modules,randomizeGearUniforms);
	class EGVAR(modules,randomizeGearVests);
	class EGVAR(modules,randomizeGearWeapons);

	class MMM_MODULES_Module_Base_Medic_F: EGVAR(modules,baseMedic)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Base Medic (Compat)";
	...
	class MMM_MODULES_Module_SpawnWreck_F: EGVAR(modules,spawnWreck)
	{
		...
		class Attributes
		{
			class MMM_MODULES_Module_SpawnWreck_ACE_Cooking_Off
			{
			...
			class MMM_MODULES_Module_SpawnWreck_Destroy_Effect
			{
	...
	class MMM_MODULES_Module_AmbientAnimationMP_F: EGVAR(modules,ambientAnimationMP)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Ambient Animation MP (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission

		class Attributes
		{
			class MMM_MODULES_Module_AmbientAnimationMP
			{
			...
			class MMM_MODULES_Module_AmbientAnimationMP_Snap_Object
			{
			...
			class MMM_MODULES_Module_AmbientAnimationMP_Damage
			{
	...
	class MMM_MODULES_Module_Animation_F: EGVAR(modules,Animation)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] SwitchMove Animation (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission

		class Attributes
		{
			class MMM_MODULES_Module_Animation_Animations
			{
			...
			class MMM_MODULES_Module_Animation_Damage
			{
	...
	class MMM_MODULES_Module_AI_Stationary_F: EGVAR(modules,aiStationary)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Turn AI Stationary (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission

		class Attributes
		{
			class MMM_MODULES_Module_AI_Stationary
			{
	...
	class MMM_MODULES_Module_Randomize_Gear_Backpacks_F: EGVAR(modules,randomizeGearBackpacks)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Gear Randomizer: Backpacks (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission
		...
		class Attributes
		{
				...
				class MMM_MODULES_Module_Randomize_Gear_Backpacks_Randomize
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Backpacks_Force
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Backpacks_Randomize_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Backpacks_Randomize_Content
				{
	...
	class MMM_MODULES_Module_Randomize_Gear_Goggles_F: EGVAR(modules,randomizeGearGoggles)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Gear Randomizer: Goggles (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission
		...
		class Attributes
		{
				...
				class MMM_MODULES_Module_Randomize_Gear_Goggles_Randomize
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Goggles_Force
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Goggles_Randomize_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Goggles_Randomize_Content
				{
	...
	class MMM_MODULES_Module_Randomize_Gear_Headgear_F: EGVAR(modules,randomizeGearHeadgear)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Gear Randomizer: Headgear (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission
		...
		class Attributes
		{
				...
				class MMM_MODULES_Module_Randomize_Gear_Headgear_Randomize
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Headgear_Force
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Headgear_Randomize_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Headgear_Randomize_Content
				{
	...
	class MMM_MODULES_Module_Randomize_Gear_Uniforms_F: EGVAR(modules,randomizeGearUniforms)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Gear Randomizer: Uniforms (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission
		...
		class Attributes
		{
				...
				class MMM_MODULES_Module_Randomize_Gear_Uniforms_Randomize
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Uniforms_Force
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Uniforms_Randomize_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Uniforms_Randomize_Content
				{
	...
	class MMM_MODULES_Module_Randomize_Gear_Vests_F: EGVAR(modules,randomizeGearVests)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Gear Randomizer: Vests (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission
		...
		class Attributes
		{
				...
				class MMM_MODULES_Module_Randomize_Gear_Vests_Randomize
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Vests_Force
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Vests_Randomize_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Vests_Randomize_Content
				{
	...
	class MMM_MODULES_Module_Randomize_Gear_Weapons_F: EGVAR(modules,randomizeGearWeapons)
	{
		// Optional: Override displayName to make it clear it's a legacy class
		displayName = "[Deprecated] Gear Randomizer: Weapons (Compat)";
		scope = 1; // Hide from 3DEN placement but still usable if it exists in a mission
		...
		class Attributes
		{
			// Primary Weapon
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Force_Primary
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Scope
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Scope_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Scope_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Rail
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Rail_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Rail_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Muzzle
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Muzzle_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Muzzle_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Bipod
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Bipod_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Primary_Attachment_Bipod_Content
				{
			...
			// Sidearm Weapon
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Force_Sidearm
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Scope
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Scope_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Scope_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Rail
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Rail_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Rail_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Muzzle
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Muzzle_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Muzzle_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Bipod
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Bipod_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Sidearm_Attachment_Bipod_Content
				{
			...
			// Secondary Weapon
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Force_Secondary
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Scope
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Scope_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Scope_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Rail
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Rail_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Rail_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Muzzle
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Muzzle_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Muzzle_Content
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Bipod
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Bipod_Chance
				{
				...
				class MMM_MODULES_Module_Randomize_Gear_Weapons_Randomize_Secondary_Attachment_Bipod_Content
				{
