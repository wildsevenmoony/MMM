class CfgVehicles
{
	...
	class MMM_Module_Base_Medic_F: Module_F
	{
		category = "MMMModuleClass";
		displayName = "Base Medic";
		function = "MMM_fnc_baseMedicInit";
		functionPriority = 10;
		isDisposable = 0;
		is3DEN = 0;
		isGlobal = 0;
	...
	class MMM_Module_SpawnWreck_F: Module_F
	{
		category = "MMMModuleClass";
		displayName = "Spawen Vehicle as Wreck";
		function = "MMM_fnc_spawnwreck";
		functionPriority = 10;
		isDisposable = 0;
		is3DEN = 0;
		isGlobal = 0;
		...
		class Attributes: AttributesBase
		{
			class MMM_Module_SpawnWreck_ACE_Cooking_Off: Combo
  			{
				property = "MMM_Module_SpawnWreck_ACE_Cooking_Off_Combo";
	...
	class MMM_Module_AmbientAnimationMP_F: Module_F
	{
		category = "MMMModuleClass";
		displayName = "Ambient Animation MP";
		function = "MMM_fnc_ambientanimationmp";
		functionPriority = 10;
		isDisposable = 0;
		is3DEN = 0;
		isGlobal = 0;
		...
		class Attributes: AttributesBase
		{
			class MMM_Module_AmbientAnimationMP: Combo
  			{
				property = "MMM_Module_AmbientAnimationMP_Combo";
			...
			class MMM_Module_AmbientAnimationMP_Snap_Object: Edit
  		{
				property = "MMM_Module_AmbientAnimationMP_Snap_Object_Edit";
	...
	/*class MMM_Module_Animation_F: Module_F
	{
		category = "MMMModuleClass";
		displayName = "SwitchMove Animation";
		function = "MMM_fnc_animation";
		functionPriority = 10;
		isDisposable = 0;
		is3DEN = 0;
		isGlobal = 0;
		...
		class Attributes: AttributesBase
		{
			class MMM_Module_Animation: Combo
  			{
					property = "MMM_Module_Animation_Combo";
	...
	class MMM_Module_AI_Stationary_F: Module_F
	{
		category = "MMMModuleClass";
		displayName = "Turn AI Stationary";
		function = "MMM_fnc_stationary_ai_init";
		functionPriority = 10;
		isDisposable = 0;
		is3DEN = 0;
		isGlobal = 0;
		...
		class Attributes: AttributesBase
		{
			class MMM_Module_AI_Stationary: Combo
  			{
					property = "MMM_Module_AI_Stationary_Combo";
