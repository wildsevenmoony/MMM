/*
 * Author: Moony
 * Opens a ZEN dialog to randomize vests for one unit or its group.
 *
 * Arguments:
 ...
 *
 * Example:
 * [position player, cursorObject] call mmm_modules_fnc_randomizeGearVestsGroupZeus
 *
 * Public: No
 */
...
[
	...
	[
		// Main
			...
			[
				...
				[
					"Use Preset",
					"Use the Vests section of an MMA gear randomization preset instead of the manual values below."
				],
				false,
				false
			],
	...
	], // Content
	{
		...
		if (_usePreset) exitWith {
			...
			private _message = ["UNIT VEST PRESET APPLIED", "GROUP VEST PRESET APPLIED"] select _randomizeGroup;
