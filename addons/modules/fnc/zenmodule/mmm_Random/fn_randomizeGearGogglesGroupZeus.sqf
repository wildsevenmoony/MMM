/*
 * Author: Moony
 * Opens a ZEN dialog to randomize goggles for one unit or its group.
 *
 * Arguments:
 ...
 *
 * Example:
 * [position player, cursorObject] call mmm_modules_fnc_randomizeGearGogglesGroupZeus
 *
 * Public: No
 */
...
[
	...
	[
		// Main
			...
			[
				...
				[
					"Use Preset",
					"Use the Goggles section of an MMA gear randomization preset instead of the manual values below."
				],
				false,
				false
			],
	...
	], // Content
	{
		...
		if (_usePreset) exitWith {
			...
			private _message = ["UNIT GOGGLE PRESET APPLIED", "GROUP GOGGLE PRESET APPLIED"] select _randomizeGroup;
